...
return [
    ...
    'database' => [
        'add_crud'                 => 'Engadir CRUD a esta táboa',
        ...
        'controller_name_hint'      => 'Exemplo. PageController, se se deixa valeiro, empregará o controlador CRUD ',
        'create_crud_for_table'    => 'Crear CRUD para a táboa :table',
        ...
        'delete_crud_before_table' => 'Asegúrese de quitar o CRUD desta táboa antes de borrar a táboa.',
        'delete_table_crud_conf'   => 'Sí, retire o CRUD',
        'delete_table_crud_quest'  => 'Está seguro de que desexa eliminar o CRUD para a táboa :table?',
        ...
        'edit_crud_for_table'      => 'Editar CRUD para a táboa :table',
        ...
        'error_creating_crud'      => 'Síntoo, parece que pode haber un problema ao crear o CRUD',
        'error_removing_crud'      => 'Síntoo, parece que houbo un problema ao eliminar o CRUD',
        'error_updating_crud'      => 'Síntoo, parece que pode haber un problema ao actualizar o CRUD',
        'extra'                     => 'Extra',
        'field'                     => 'Campo',
        ...
        'success_update_crud'      => 'Actualizouse correctamente o CRUD :datatype',
        ...
        'relationship'              => [
            ...
            'before_create'             => 'Antes de que poida crear unha nova relación, primeiro deberá crear o CRUD. <br> Despois, regrese para editar o CRUD e poderá agregar relacións. Grazas.',
            'cancel'                    => 'Cancelar',
    ...
    'theme' => [
        'footer_copyright'  => 'Feito con <i class = "admin-heart"> </i> por',
