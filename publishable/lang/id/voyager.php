...
return [
    ...
    'database' => [
        'add_crud'                 => 'Tambahkan CRUD pada tabel ini',
        ...
        'controller_name_hint'      => 'cth. PageController, jika dikosongkan akan memakai CRUD Controller',
        'create_crud_for_table'    => 'Buat CRUD untuk table :table',
        ...
        'default'                   => 'Default',
        'delete_crud'              => 'Hapus CRUD',
        'delete_crud_before_table' => 'Pastikan untuk menghapus CRUD pada tabel ini terlebih dahulu sebelum menghapus tabel.',
        'delete_table_crud_conf'   => 'Ya, hapus CRUD',
        'delete_table_crud_quest'  => 'Kamu yakin untuk menghapus CRUD untuk tabel :table?',
        ...
        'edit_crud'                => 'Ubah CRUD',
        'edit_crud_for_table'      => 'Ubah CRUD untuk tabel :table',
        ...
        'error_creating_crud'      => 'Maaf, sepertinya terjadi masalah ketika membuat CRUD',
        'error_removing_crud'      => 'Maaf, sepertinya terjadi masalah ketika menghapus CRUD',
        'error_updating_crud'      => 'Maaf, sepertinya terjadi masalah ketika mengubah CRUD',
        'extra'                     => 'Ekstra',
        'field'                     => 'Field',
        ...
        'success_created_crud'     => 'Berhasil membuat CRUD baru',
        'success_delete_table'      => 'Berhasil menghapus :table',
        'success_remove_crud'      => 'Berhasil menghapus CRUD dari :datatype',
        'success_update_crud'      => 'Berhasil mengubah :datatype CRUD',
        ...
        'relationship'              => [
            ...
            'before_create'        => 'Sebelum membuat relationship kamu harus membuat CRUD terlebih dahulu.<br> Lalu, kembali untuk mengubah CRUD dan kamu dapat menambahkan relationships.<br> Terima kasih.',
            'cancel'               => 'Batal',
    ...
    'theme' => [
        'footer_copyright'  => 'Dibuat dengan <i class="admin-heart"></i> oleh',
