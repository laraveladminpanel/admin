...
return [
    ...
    'database' => [
        'add_crud'                 => 'Ajouter le CRUD à cette table',
        ...
        'crud_crud_actions'        => 'Actions du CRUD/CRUD',
        'crud_info'                => 'Information du CRUD',
        'browse_crud'              => 'Parcourir CRUD',
        'column'                    => 'Colonne',
        'composite_warning'         => 'Avertissement : cette colonne fait partie d\'un indice composite '.
                                       '(composite index)',
        'controller_name'           => 'Nom du controleur',
        'controller_name_hint'      => 'exemple : PageController. Si laissé vide, utilisera le contrôleur CRUD',
        'create_crud_for_table'    => 'Créer un CRUD pour la table :table',
        ...
        'default'                   => 'Par défaut',
        'delete_crud'              => 'Supprimer le CRUD',
        'delete_crud_before_table' => 'Assurez-vous de supprimer le CRUD avant de supprimer sa table.',
        'delete_table_crud_conf'   => 'Oui, supprimer le CRUD',
        'delete_table_crud_quest'  => 'Êtes-vous sûr de vouloir supprimer le CRUD de la table : :table ?',
        ...
        'edit_crud'                => 'Editer le CRUD',
        'edit_crud_for_table'      => 'Editer le CRUD de la table : :table',
        ...
        'error_creating_crud'      => 'Désolé, il semble qu\'il y ait eu un problème pour créer ce CRUD',
        'error_removing_crud'      => 'Désolé, il semble qu\'il y ait eu un problème pour supprimer ce CRUD',
        'error_updating_crud'      => 'Désolé, il semble qu\'il y ait eu un problème pour mettre à jour ce CRUD',
        'extra'                     => 'Extra',
        'field'                     => 'Champ',
        ...
        'success_created_crud'     => 'Nouveau CRUD créé avec succès',
        'success_delete_table'      => 'Table : :table supprimée avec succès',
        'success_remove_crud'      => ':datatype CRUD supprimé avec succès',
        'success_update_crud'      => ':datatype CRUD mis à jour avec succès',
        ...
        'relationship'              => [
            ...
            'before_create'        => 'Avant de créer une nouvelle relation, vous devez créer le CRUD !<br>'.
                                      'Revenez ensuite éditer le CRUD, vous pourrez y ajouter des relations.<br>'.
                                      'Merci.',
            'cancel'               => 'Annuler',
