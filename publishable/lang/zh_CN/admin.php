...
return [
    ...
    'database' => [
        ...
        'controller_name_hint'      => '例如：PageController，如果留空将使用自带的 CRUD Controller',
        'create_crud_for_table'    => '为表 :table 创建 CRUD',
        ...
        'default'                   => '默认',
        'delete_crud'              => '删除 CRUD',
        'delete_crud_before_table' => '请务必在删除表前先删除该表的 CRUD。',
        'delete_table_crud_conf'   => '是的，删除该 CRUD',
        'delete_table_crud_quest'  => '你确定要删除 :table 表的 CRUD吗？',
        ...
        'edit_crud'                => '编辑 CRUD',
        'edit_crud_for_table'      => '编辑 CRUD :table',
        'edit_rows'                 => '在下方编辑 :table 行',
        'edit_table'                => '在下方编辑 :table 表',
        'edit_table_not_exist'      => '您想要编辑的表不存在',
        'error_creating_crud'      => '很抱歉，在创建 CRUD 时出现了问题',
        'error_removing_crud'      => '很抱歉，在删除 CRUD 时出现了问题',
        'error_updating_crud'      => '很抱歉，在更新 CRUD 时出现了问题',
        'extra'                     => '额外',
        'field'                     => '字段',
        ...
        'success_created_crud'     => '成功创建 CRUD',
        'success_delete_table'      => '成功删除表 :table',
        'success_remove_crud'      => '成功地从 :datatype 中移除 CRUD',
        'success_update_crud'      => '成功更新 :datatype CRUD',
        ...
        'relationship'              => [
            ...
            'store_the'            => '保存',
            'easy_there'           => '别慌，舰长！',
            'before_create'        => '在您创建新关系时，您需要先创建它的 CRUD。<br>在这之后，返回到 CRUD 的编辑页面您就可以看到创建关系的相关项。',
            'cancel'               => '取消',
            'add_new'              => '添加新关系',
            'open'                 => '打开',
            'close'                => '关闭',
