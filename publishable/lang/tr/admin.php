...
return [
    ...
    'database' => [
        ...
        'controller_name_hint'      => 'örn. PageController, eğer boş bırakırsanı CRUD kontrolü kullanır',
        'create_crud_for_table'    => ':table tablosu için CRUD oluştur',
        ...
        'default'                   => 'Varsayılan',
        'delete_crud'              => 'CRUD sil',
        'delete_crud_before_table' => "Lütfen tabloyu silmeden önce bu tablodaki CRUD'i kaldırdığınızdan emin olun.",
        'delete_table_crud_conf'   => "Evet,CRUD'i sil",
        'delete_table_crud_quest'  => ":table tablosunda CRUD'i silmek istediğinizden eminmisiniz ? ",
        ...
        'edit_crud_for_table'      => ':table tablosu için CRUD düzenle',
        ...
        'error_creating_crud'      => "Maalesef, bu CRUD'i oluşturmakta bir sorun olabilir gibi görünüyor",
        'error_removing_crud'      => "Maalesef, bu CRUD'i düzenlemekte bir sorun olabilir gibi görünüyor",
        'error_updating_crud'      => "Maalesef, bu CRUD'i güncellemekde bir sorun olabilir gibi görünüyor",
        'extra'                     => 'Extra',
        'field'                     => 'Alan',
        ...
        'success_created_crud' => 'Başarılı yeni CRUD oluşturuldu',
        'success_delete_table'  => 'Başarılı tablo silindi :table table',
        'success_remove_crud'  => 'Başarılı silindi CRUD şurdan :datatype',
        'success_update_crud'  => 'Başarılı güncellendi :datatype CRUD',
