...
return [
    ...
    'database' => [
        'add_crud'                 => 'Añadir CRUD a esta tabla',
        ...
        'crud_crud_actions'        => 'Acciones CRUD / CRUD',
        ...
        'controller_name_hint'      => 'Ejemplo. PageController, si se deja vacío, utilizará el controlador CRUD ',
        'create_crud_for_table'    => 'Crear CRUD para la tabla :table',
        ...
        'default'                   => 'Defecto',
        'delete_crud'              => 'Eliminar CRUD',
        'delete_crud_before_table' => 'Asegúrese de quitar el CRUD de esta tabla antes de borrar la tabla.',
        'delete_table_crud_conf'   => 'Sí, retire el CRUD',
        'delete_table_crud_quest'  => '¿Está seguro de que desea eliminar el CRUD para la tabla :table?',
        ...
        'edit_crud_for_table'      => 'Editar CRUD para la tabla :table',
        ...
        'error_creating_crud'      => 'Lo siento, parece que puede haber habido un problema al crear el CRUD',
        'error_removing_crud'      => 'Lo siento, parece que hubo un problema al eliminar el CRUD',
        'error_updating_crud'      => 'Lo siento, parece que puede haber habido un problema al actualizar el CRUD',
        'extra'                     => 'Extra',
        'field'                     => 'Campo',
        ...
        'success_created_crud' => 'CRUD creado exitosamente',
        'success_delete_table'  => 'Tabla :table eliminada exitosamente',
        'success_remove_crud'  => 'CRUD de tipo :datatype borrado exitosamente',
        'success_update_crud'  => 'Se actualizó correctamente el CRUD :datatype',
        ...
        'relationship'          => [
            ...
            'before_create'        => 'Antes de que pueda crear una nueva relación, primero deberá crear el CRUD. <br> Luego, regrese para editar el CRUD y podrá agregar relaciones. Gracias.',
            'cancel'               => 'Cancelar',
