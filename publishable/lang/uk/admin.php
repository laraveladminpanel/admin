...
return [
    ...
    'database' => [
        'add_crud'                 => 'Додати CRUD до даної таблиці',
        ...
        'browse_crud'               => 'Переглянути CRUD',
        'column'                    => 'Стовпчик',
        'composite_warning'         => 'Попередження: цей стовпчик є частиною складового індексу',
        'controller_name'           => 'Назва контролера',
        'controller_name_hint'      => 'наприклад, порожній PageController,  буде використовувати CRUD Controller',
        'create_crud_for_table'    => 'Створити CRUD для таблиці :table',
        ...
        'default'                   => 'За замовчуванням',
        'delete_crud'              => 'Видалити CRUD',
        'delete_crud_before_table' => 'Перед видаленням таблиці обов\'язково видаліть CRUD таблиці.',
        'delete_table_crud_conf'   => 'Так, видалити CRUD',
        'delete_table_crud_quest'  => 'Ви впевнені, що хочете видалити CRUD для таблиці :table?',
        ...
        'edit_crud'                => 'Редагувати CRUD',
        'edit_crud_for_table'      => 'Редагувати CRUD для таблиці :table',
        ...
        'error_creating_crud'      => 'Схоже, виникла проблема з створенням даного CRUD',
        'error_removing_crud'      => 'Схоже, виникла проблема з видаленням даного CRUD',
        'error_updating_crud'      => 'Схоже, виникла проблема з оновленням даного CRUD',
        'extra'                     => 'Додатково',
        'field'                     => 'Поле',
        ...
        'success_remove_crud'      => 'CRUD успішно видалений з :datatype',
        'success_update_crud'      => 'CRUD успішно оновлений в :datatype',
        ...
        'relationship'              => [
            ...
            'has_many'             => 'Має багато',
            'belongs_to'           => 'Належить',
            'belongs_to_many'      => 'Належить до багатьох',
            'which_column_from'    => 'Який стовпчик з',
            'is_used_to_reference' => 'використовується для посилання на',
            'pivot_table'          => 'Стовпчаста таблиця',
            'selection_details'    => 'Інформація про вибір',
            'display_the'          => 'Відобразити',
            'store_the'            => 'Зберегти',
            'allow_tagging'        => 'Дозволити тегування',
            'easy_there'           => 'Легко там',
            'before_create'        => 'Перш ніж ви зможете створити нові відносини, вам потрібно спочатку створити CRUD. <br> Потім поверніться назад, щоб відредагувати CRUD, і ви зможете додавати відносини.',
            'cancel'               => 'Відміна',
            'add_new'              => 'Додати нове',
            'open'                 => 'Відкрити',
            'close'                => 'Закрити',
            'relationship_details' => 'Опції',
            'browse'               => 'Перегляд',
            'read'                 => 'Читати',
            'edit'                 => 'Змінити',
            'add'                  => 'Додати',
