...
return [
    ...
    'database' => [
        'add_crud'                 => 'Aggiungi CRUD a questa tabella',
        ...
        'controller_name_hint'      => 'es. PageController, se lasciato vuoto verrà usato il CRUD Controller',
        'create_crud_for_table'    => 'Crea CRUD per la tabella :table',
        ...
        'default'                   => 'Default',
        'delete_crud'              => 'Elimina CRUD',
        'delete_crud_before_table' => 'Assicurati di eliminare il CRUD in questa tabella prima di eliminare la tabella.',
        'delete_table_crud_conf'   => 'Sì, elimina il CRUD',
        'delete_table_crud_quest'  => 'Sei sicuro di voler eliminare il CRUD per la tabella :table?',
        ...
        'edit_crud'                => 'Modifica CRUD',
        'edit_crud_for_table'      => 'Modifica CRUD per la tabella :table',
        ...
        'error_creating_crud'      => 'Spiacenti sembra ci sia stato un problema nel creare questo CRUD',
        'error_removing_crud'      => 'Spiacenti sembra ci sia stato un problema nell\'eliminare questo CRUD',
        'error_updating_crud'      => 'Spiacenti sembra ci sia stato un problema nell\'aggiornare questo CRUD',
        'extra'                     => 'Aggiuntivo',
        'field'                     => 'Campo',
        ...
        'success_created_crud' => 'Nuovo CRUD creato con successo',
        'success_delete_table'  => 'Tabella :table eliminata con successo',
        'success_remove_crud'  => 'CRUD rimosso con successo da :datatype',
        'success_update_crud'  => 'Aggiornato con successo :datatype CRUD',
