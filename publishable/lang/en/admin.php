...
return [
    ...
    'database' => [
        'add_crud'                 => 'Add CRUD to this table',
        ...
        'controller_name_hint'      => 'ex. PageController, if left empty will use the CRUD Controller',
        'create_crud_for_table'    => 'Create CRUD for :table table',
        ...
        'delete_crud_before_table' => 'Please make sure to remove the CRUD on this table before deleting the table.',
        'delete_table_crud_conf'   => 'Yes, remove the CRUD',
        'delete_table_crud_quest'  => 'Are you sure you want to delete the CRUD for the :table table?',
        ...
        'edit_crud'                => 'Edit CRUD',
        'edit_crud_for_table'      => 'Edit CRUD for :table table',
        ...
        'error_creating_crud'      => 'Sorry it appears there may have been a problem creating this CRUD',
        'error_removing_crud'      => 'Sorry it appears there was a problem removing this CRUD',
        'error_updating_crud'      => 'Sorry it appears there may have been a problem updating this CRUD',
        'extra'                     => 'Extra',
        'field'                     => 'Field',
        ...
        'success_created_crud'     => 'Successfully created new CRUD',
        'success_delete_table'      => 'Successfully deleted :table table',
        'success_remove_crud'      => 'Successfully removed CRUD from :datatype',
        'success_update_crud'      => 'Successfully updated the :datatype CRUD',
        ...
        'relationship'              => [
            ...
            'before_create'        => 'Before you can create a new relationship you will need to create the CRUD first.<br> Then, return back to edit the CRUD and you will be able to add relationships.<br> Thanks.',
            'cancel'               => 'Cancel',
