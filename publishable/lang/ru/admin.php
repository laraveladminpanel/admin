...
return [
    ...
    'database' => [
        'add_crud'                 => 'Добавить CRUD к данной таблице',
        ...
        'crud_crud_actions'        => 'CRUD/CRUD действия',
        ...
        'controller_name_hint'      => 'например, пустой PageController,  будет использовать CRUD Controller',
        'create_crud_for_table'    => 'Создать CRUD для таблицы :table',
        ...
        'default'                   => 'По умолчанию',
        'delete_crud'              => 'Удалить CRUD',
        'delete_crud_before_table' => 'Перед удалением таблицы обязательно удалите CRUD таблицы.',
        'delete_table_crud_conf'   => 'Да, удалить CRUD',
        'delete_table_crud_quest'  => 'Вы уверены, что хотите удалить CRUD для таблицы :table?',
        ...
        'edit_crud'                => 'Редактировать CRUD',
        'edit_crud_for_table'      => 'Редактировать CRUD для таблицы :table',
        ...
        'error_creating_crud'      => 'Похоже, возникла проблема с созданием данного CRUD',
        'error_removing_crud'      => 'Похоже, возникла проблема с удалением данного CRUD',
        'error_updating_crud'      => 'Похоже, возникла проблема с обновлением данного CRUD',
        'extra'                     => 'Дополнительно',
        'field'                     => 'Поле',
        ...
        'success_created_crud'     => 'Новый CRUD успешно создан',
        'success_delete_table'      => 'Таблица :table успешно удалена',
        'success_remove_crud'      => 'CRUD успешно удален из :datatype',
        'success_update_crud'      => 'CRUD успешно обновлен в :datatype',
        ...
        'relationship'              => [
            ...
            'belongs_to_many'      => 'Принадлежит многим',
            ...
            'display_the'          => 'Отобразить',
            'store_the'            => 'Сохранить',
            'allow_tagging'        => 'Разрешить тегирование',
            'easy_there'           => 'Легко там',
            'before_create'        => 'Прежде чем вы сможете создать новые отношения, вам нужно сначала создать CRUD. <br> Затем вернитесь назад, чтобы отредактировать CRUD, и вы сможете добавлять отношения.',
            'cancel'               => 'Отмена',
            'add_new'              => 'Добавить новое отношение',
            'open'                 => 'Открыть',
            'close'                => 'Закрыть',
            'relationship_details' => 'Опции',
            'browse'               => 'Просматреть',
            'read'                 => 'Читать',
            'edit'                 => 'Изменить',
            'add'                  => 'Добавить',
