...
return [
    ...
    'database' => [
        'add_crud'                 => 'Přidat CRUD do této tabulky',
        ...
        'controller_name_hint'      => 'např. PageController, pokud zůstane nevyplněno, bude použit CRUD Controller',
        'create_crud_for_table'    => 'Vytvořit CRUD pro :table',
        ...
        'default'                   => 'Výchozí',
        'delete_crud'              => 'Smazat CRUD',
        'delete_crud_before_table' => 'Prosím smažte nejdříve CRUD odkazující na tuto tabulku před jejím smazání.',
        'delete_table_crud_conf'   => 'Ano, smazat CRUD',
        'delete_table_crud_quest'  => 'Jste si jist, že chcete smazat CRUD pro tabulku :table?',
        ...
        'edit_crud'                => 'Upravit CRUD',
        'edit_crud_for_table'      => 'Upravit CRUD pro tabulku :table',
        ...
        'error_creating_crud'      => 'Vypadá to, že nastal problém při vytváření tohoto CRUDu',
        'error_removing_crud'      => 'Vypadá to, že nastal problém při mazání tohoto CRUDu',
        'error_updating_crud'      => 'Vypadá to, že nastal problém při editaci tohoto CRUDu',
        'extra'                     => 'Extra',
        'field'                     => 'Pole',
        ...
        'success_created_crud'     => 'Úspěšně vytvořen nový CRUD',
        'success_delete_table'      => 'Úspěšně smazána tabulka :table',
        'success_remove_crud'      => 'Úspěšně smazán CRUD z :datatype',
        'success_update_crud'      => 'Úspěšně upraven :datatype CRUD',
        ...
        'relationship'              => [
            ...
            'before_create'        => 'Než vytvoříte nový vztah, musíte vytvořit nejdříve CRUD.<br> Poté se vraťte zpět pro editaci CRUDu a teprve pak můžete vytvořit vztah.<br> Díky.',
            'cancel'               => 'Zrušit',
    ...
    'theme' => [
        'footer_copyright'  => 'Vytvořeno s <i class="admin-heart"></i> od',
