...
return [
    ...
    'database' => [
        'add_crud'                 => 'أضف CRUD إلى هذا الجدول',
        ...
        'controller_name_hint'      => 'مثال PageController, إذا تركت فارغة ستستخدم ال CRUD Controller',
        'create_crud_for_table'    => 'إنشاء ال CRUD للجدول :table',
        ...
        'default'                   => 'افتراضي',
        'delete_crud'              => 'حذف ال CRUD',
        'delete_crud_before_table' => 'الرجاء التأكد من إزالة ال CRUD الخاصة بهذا الجدول قبل حذف الجدول.',
        'delete_table_crud_conf'   => 'نعم، إزالة ال CRUD',
        'delete_table_crud_quest'  => 'هل أنت متأكد من حذف ال CRUD للجدول :table ؟',
        ...
        'edit_crud'                => 'تعديل ال CRUD',
        'edit_crud_for_table'      => 'تعديل ال CRUD للجدول :table',
        ...
        'error_creating_crud'      => 'عذراً، يبدو أن هناك مشكلة في إنشاء هذا ال CRUD',
        'error_removing_crud'      => 'عذراً، يبدو أنه حدثت مشكلة أثناء إزالة ال CRUD',
        'error_updating_crud'      => 'عذرا، يبدو أنه قد حدثت مشكلة أثناء تحديث هذا ال CRUD',
        'extra'                     => 'إضافي',
        'field'                     => 'حقل',
        ...
        'success_created_crud'     => 'تم إنشاء CRUD بنجاح',
        'success_delete_table'      => 'تم حذف الجدول :table بنجاح',
        'success_remove_crud'      => 'تم إزالة ال CRUD من :datatype بنجاح',
        'success_update_crud'      => 'تم تحديث ال CRUD الخاصة ب :datatype بنجاح',
        ...
        'relationship'              => [
            ...
            'before_create'        => 'قبل أن تنشئ علاقة جديدة ستحتاج أن تنشئ CRUD أولا.<br>ثم عد لتعديل ال CRUD وستتمكن من إضافة العلاقات.<br>شكرا.',
