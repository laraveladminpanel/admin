                ...
                @endif
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="admin-edit"></i> {{ ucfirst($table) }} {{ __('admin.database.crud_info') }}</h3>
                        ...
                        <div class="panel-body">
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="name">{{ __('admin.database.table_name') }}</label>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('admin.database.display_name_singular') }}"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('admin.database.display_name_plural') }}"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="email">{{ __('admin.database.icon_hint') }} <a
                                                ...
                                                target="_blank">{{ __('admin.database.icon_hint2') }}</a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="{{ __('admin.database.icon_class') }}"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    <span class="admin-question"
                                        ...
                                        title="{{ __('admin.database.model_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="{{ __('admin.database.model_class') }}"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <span class="admin-question"
                                        ...
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('admin.database.controller_name_hint') }}"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="{{ __('admin.database.controller_name') }}"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    <span class="admin-question"
                                          ...
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('admin.database.policy_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="{{ __('admin.database.policy_class') }}"
                                           value="@if(isset($dataType->policy_name)){{ $dataType->policy_name }}@endif">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="generate_permissions">{{ __('admin.database.generate_permissions') }}</label><br>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="admin-list"></i> {{ __('admin.database.edit_rows', ['table' => $table]) }}:</h3>
                            <div class="panel-actions">
                                <a class="panel-action admin-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                <div class="col-xs-2">{{ __('admin.database.field') }}</div>
                                <div class="col-xs-2">{{ __('admin.database.visibility') }}</div>
                                <div class="col-xs-2">{{ __('admin.database.input_type') }}</div>
                                <div class="col-xs-2">{{ __('admin.database.display_name') }}</div>
                                <div class="col-xs-4">{{ __('admin.database.optional_details') }}</div>
                            </div>
                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                @if(isset($dataType->id))
                                    <?php $dataRow = LaravelAdminPanel\Models\DataRow::where('data_type_id', '=',
                                ...
                                <div class="row row-dd">
                                    <div class="col-xs-2">
                                        ...
                                        <strong>{{ __('admin.database.type') }}:</strong> <span>{{ $data['type'] }}</span><br/>
                                        <strong>{{ __('admin.database.key') }}:</strong> <span>{{ $data['key'] }}</span><br/>
                                        <strong>{{ __('admin.generic.required') }}:</strong>
                                        @if($data['null'] == "NO")
                                            <span>{{ __('admin.generic.yes') }}</span>
                                    ...
                                    <div class="col-xs-2">
                                        <input type="checkbox"
                                               ...
                                               @elseif(!isset($dataRow->browse))
                                                    {{ 'checked="checked"' }}
                                               @endif>
                                        <label for="field_browse_{{ $data['field'] }}">{{ __('admin.generic.browse') }}</label><br/>
                                        <input type="checkbox"
                                        ...
                                        <label for="field_read_{{ $data['field'] }}">{{ __('admin.generic.read') }}</label><br/>
                                        <input type="checkbox"
                                        ...
                                        <label for="field_edit_{{ $data['field'] }}">{{ __('admin.generic.edit') }}</label><br/>
                                        <input type="checkbox"
                                            ...
                                            <label for="field_add_{{ $data['field'] }}">{{ __('admin.generic.add') }}</label><br/>
                                        <input type="checkbox"
                                               ...
                                               name="field_delete_{{ $data['field'] }}" @if(isset($dataRow->delete) && $dataRow->delete){{ 'checked="checked"' }}@elseif($data['key'] == 'PRI')@elseif($data['type'] == 'timestamp' && $data['field'] == 'updated_at')@elseif(!isset($dataRow->delete)){{ 'checked="checked"' }}@endif>
                                                <label for="field_delete_{{ $data['field'] }}">{{ __('admin.generic.delete') }}</label><br/>
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="hidden" name="field_{{ $data['field'] }}" value="{{ $data['field'] }}">
                                        @if($data['type'] == 'timestamp')
                                            <p>{{ __('admin.generic.timestamp') }}</p>
                        ...
                        <div class="panel-footer">
                             ...
                             {{ __('admin.database.relationship.create') }}</span></div>
                                                 <button type="submit" class="btn pull-right btn-primary">{{ __('admin.generic.submit') }}</button>
                        </div>
                    </div><!-- .panel -->
                </form>
            </div><!-- .col-md-12 -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="admin-list"></i> {{ ucfirst($table) }} {{ __('admin.database.other_crud') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action admin-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
    ...
    <script>
            ...
            $('textarea[data-editor]').each(function () {
                ...
                textarea.closest('form').on('submit', function (ev) {
                    if (window.invalidEditors.length) {
                        ...
                        toastr.error('{{ __('admin.json.invalid_message') }}', '{{ __('admin.json.validation_errors') }}', {"preventDuplicates": true, "preventOpenDuplicates": true});
                    } else {
       ...
       $(function () {
        ...
        function populateRowsFromTable(dropdown){
            ...
            if(tbl.length != 0){
                $.get('{{ route('admin.database.index', [], false) }}/' + tbl, function(data){
                    $(dropdown).empty();
