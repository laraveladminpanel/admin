<style type="text/css">
        .admin .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .admin .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .admin .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/laraveladminpanel/admin/assets/images/bg.jpg);
        ...
        .admin .compass .nav-tabs > li > a:hover{
        ...
        .admin-link span.resource_label{
            text-align: center;
            color: #fff;
            display: block;
            position: absolute;
        ...
        .admin-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .admin-link span.resource_label:hover i{
            
            opacity:1;
            transition:all 0.3s linear;
        }

        .admin-link span.copy{
            position: absolute;
            font-size: 16px;
            left: 0px;
            bottom: 70px;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .admin #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .admin #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
