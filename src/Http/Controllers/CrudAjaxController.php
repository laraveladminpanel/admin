...
//dd($columns, $dataType->browseRows);
    ...
    public function getAjaxList($slug)
    {
        // GET THE SLUG, ex. 'posts', 'pages', etc.
        //$slug = $this->getSlug($request);
        ...
        //dd($dataType->ajaxColums());
        //dd($dataType->ajaxRows());
        $model = app($dataType->model_name);

        $model->select($dataType->fields())->latest($model::CREATED_AT);
...
//dd(Datatables::of($query->latest($model::CREATED_AT))->make(true));
